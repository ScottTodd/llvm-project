...
std::unique_ptr<llvm::Module> ModuleTranslation::prepareLLVMModule(
  ...
  if (configTriple.isKnownWindowsMSVCEnvironment()) {
    // Dwarf debugging files will be generated by default, unless "CodeView" is
    // set explicitly. Windows/MSVC should use CodeView instead.
